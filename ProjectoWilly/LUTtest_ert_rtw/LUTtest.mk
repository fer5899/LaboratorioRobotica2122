###########################################################################
## Makefile generated for component 'LUTtest'. 
## 
## Makefile     : LUTtest.mk
## Generated on : Fri Dec 03 16:11:21 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/LUTtest.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/LUTtest.elf
...
DEFINES_STANDARD = -DMODEL=LUTtest -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o xcp_ext_mode.o LUTtest.o LUTtest_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_frame_serial.o xcp_ext_param_default_serial.o EncoderWilly_wrapper.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/LUTtest_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/LUTtest_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/LUTtest_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
LUTtest.o : $(START_DIR)/LUTtest_ert_rtw/LUTtest.c
	$(CC) $(CFLAGS) -o "$@" "$<"


LUTtest_data.o : $(START_DIR)/LUTtest_ert_rtw/LUTtest_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/LUTtest_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
