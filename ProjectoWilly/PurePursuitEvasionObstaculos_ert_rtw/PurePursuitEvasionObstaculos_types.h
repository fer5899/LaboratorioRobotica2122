 ...
 *
 * File: PurePursuitEvasionObstaculos_types.h
 *
...
#ifndef RTW_HEADER_PurePursuitEvasionObstaculos_types_h_
#define RTW_HEADER_PurePursuitEvasionObstaculos_types_h_
#include "rtwtypes.h"

/* Model Code Variants */

/* Custom Type definition for MATLABSystem: '<S113>/PWM3' */
#include "MW_SVD.h"
...
typedef struct P_PurePursuitEvasionObstaculo_T_ P_PurePursuitEvasionObstaculo_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_PurePursuitEvasionObs_T RT_MODEL_PurePursuitEvasionOb_T;

#endif                    /* RTW_HEADER_PurePursuitEvasionObstaculos_types_h_ */
