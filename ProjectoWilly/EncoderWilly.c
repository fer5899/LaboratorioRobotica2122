 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Fri Dec 10 16:53:42 2021
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                EncoderWilly
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  const uint8_T *pinA0 = (const uint8_T *) mxGetData(PARAM_DEF0(S));
  const uint8_T *pinB0 = (const uint8_T *) mxGetData(PARAM_DEF1(S));
