###########################################################################
## Makefile generated for component 'ControlWillyBAlut'. 
## 
## Makefile     : ControlWillyBAlut.mk
## Generated on : Fri Dec 03 17:40:49 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ControlWillyBAlut.elf
...
PRODUCT_NAME              = ControlWillyBAlut
MAKEFILE                  = ControlWillyBAlut.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ControlWillyBAlut.elf
...
DEFINES_STANDARD = -DMODEL=ControlWillyBAlut -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o xcp_ext_mode.o ControlWillyBAlut.o ControlWillyBAlut_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_frame_serial.o xcp_ext_param_default_serial.o EncoderWilly_wrapper.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/ControlWillyBAlut_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/ControlWillyBAlut_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/ControlWillyBAlut_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ControlWillyBAlut.o : $(START_DIR)/ControlWillyBAlut_ert_rtw/ControlWillyBAlut.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ControlWillyBAlut_data.o : $(START_DIR)/ControlWillyBAlut_ert_rtw/ControlWillyBAlut_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/ControlWillyBAlut_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
