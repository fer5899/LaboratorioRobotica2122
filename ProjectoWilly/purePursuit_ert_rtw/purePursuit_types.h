...
#ifndef RTW_HEADER_purePursuit_types_h_
#define RTW_HEADER_purePursuit_types_h_
#include "rtwtypes.h"

/* Model Code Variants */

/* Custom Type definition for MATLABSystem: '<S109>/PWM3' */
#include "MW_SVD.h"
...
typedef struct P_purePursuit_T_ P_purePursuit_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_purePursuit_T RT_MODEL_purePursuit_T;

#endif                                 /* RTW_HEADER_purePursuit_types_h_ */
