###########################################################################
## Makefile generated for component 'salirClaseStateFlow'. 
## 
## Makefile     : salirClaseStateFlow.mk
## Generated on : Fri Jan 14 17:30:47 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/salirClaseStateFlow.elf
...
PRODUCT_NAME              = salirClaseStateFlow
MAKEFILE                  = salirClaseStateFlow.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/salirClaseStateFlow.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021b/toolbox/target/shared/svd/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021b/toolbox/target/SUPPOR~1/ARDUIN~2/include -I$(START_DIR)/salirClaseStateFlow_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/mega -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021b/toolbox/target/SUPPOR~1/ARDUIN~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021b/toolbox/target/SUPPOR~1/ARDUIN~1/SCHEDU~1/include -I$(ARDUINO_ROOT)/hardware/tools/avr/avr/include/avr -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021b/toolbox/target/shared/EXTERN~1/include
...
DEFINES_STANDARD = -DMODEL=salirClaseStateFlow -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o salirClaseStateFlow.o salirClaseStateFlow_data.o EncoderWilly_wrapper.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/salirClaseStateFlow_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/salirClaseStateFlow_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/salirClaseStateFlow_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/salirClaseStateFlow_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


salirClaseStateFlow.o : $(START_DIR)/salirClaseStateFlow_ert_rtw/salirClaseStateFlow.c
	$(CC) $(CFLAGS) -o "$@" "$<"


salirClaseStateFlow_data.o : $(START_DIR)/salirClaseStateFlow_ert_rtw/salirClaseStateFlow_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
