###########################################################################
## Makefile generated for component 'baldosa90baldosa'. 
## 
## Makefile     : baldosa90baldosa.mk
## Generated on : Fri Dec 17 17:48:32 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/baldosa90baldosa.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/baldosa90baldosa.elf
...
DEFINES_STANDARD = -DMODEL=baldosa90baldosa -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o baldosa90baldosa.o baldosa90baldosa_data.o EncoderWilly_wrapper.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/baldosa90baldosa_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/baldosa90baldosa_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/baldosa90baldosa_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
baldosa90baldosa.o : $(START_DIR)/baldosa90baldosa_ert_rtw/baldosa90baldosa.c
	$(CC) $(CFLAGS) -o "$@" "$<"


baldosa90baldosa_data.o : $(START_DIR)/baldosa90baldosa_ert_rtw/baldosa90baldosa_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/baldosa90baldosa_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
