###########################################################################
## Makefile generated for component 'ControlWillyConVW'. 
## 
## Makefile     : ControlWillyConVW.mk
## Generated on : Fri Dec 10 18:05:17 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ControlWillyConVW.elf
...
PRODUCT_NAME              = ControlWillyConVW
MAKEFILE                  = ControlWillyConVW.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ControlWillyConVW.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021b/toolbox/target/shared/svd/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021b/toolbox/target/SUPPOR~1/ARDUIN~2/include -I$(START_DIR)/ControlWillyConVW_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/mega -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021b/toolbox/target/SUPPOR~1/ARDUIN~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021b/toolbox/target/SUPPOR~1/ARDUIN~1/SCHEDU~1/include -I$(ARDUINO_ROOT)/hardware/tools/avr/avr/include/avr -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021b/toolbox/target/shared/EXTERN~1/include
...
DEFINES_STANDARD = -DMODEL=ControlWillyConVW -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o ControlWillyConVW.o ControlWillyConVW_data.o EncoderWilly_wrapper.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o
...
%.o : $(START_DIR)/ControlWillyConVW_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/ControlWillyConVW_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/ControlWillyConVW_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ControlWillyConVW.o : $(START_DIR)/ControlWillyConVW_ert_rtw/ControlWillyConVW.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ControlWillyConVW_data.o : $(START_DIR)/ControlWillyConVW_ert_rtw/ControlWillyConVW_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/ControlWillyConVW_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
