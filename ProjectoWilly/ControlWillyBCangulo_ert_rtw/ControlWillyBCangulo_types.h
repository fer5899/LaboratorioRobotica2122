 ...
 *
 * File: ControlWillyBCangulo_types.h
 *
...
#ifndef RTW_HEADER_ControlWillyBCangulo_types_h_
#define RTW_HEADER_ControlWillyBCangulo_types_h_
#include "rtwtypes.h"

/* Model Code Variants */

/* Custom Type definition for MATLABSystem: '<S157>/PWM3' */
#include "MW_SVD.h"
...
typedef struct P_ControlWillyBCangulo_T_ P_ControlWillyBCangulo_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_ControlWillyBCangulo_T RT_MODEL_ControlWillyBCangulo_T;

#endif                            /* RTW_HEADER_ControlWillyBCangulo_types_h_ */
